...
function askQuestion (index) {
    ...
    for(var i = 0; i < shuffleAnswers.length; i++) {
        ...
        console.log(shuffleAnswers[i].image)
        var b = document.getElementById(`mcp-p${i+1}`);
        b.src = shuffleAnswers[i].image;
        a.innerText = shuffleAnswers[i].text;
        console.log('B', b)
    }
    
    // var answr1 = document.querySelector('#mcp-p1');
    // answr1.innerText = array[index].answers[shuffled_questions[0]].key;
    // answer1.src = array[index].image1;
    // var answr2 = document.querySelector('#mcp-p2');
    // answr2.innerText = array[index].answers[shuffled_questions[1]];
    // var answr3 = document.querySelector('#mcp-p3');
    // answr3.innerText = array[index].answers[shuffled_questions[2]];
    // var answr4 = document.querySelector('#mcp-p4');
    // answr4.innerText = array[index].answers[shuffled_questions[3]];

    // var answr1 = document.querySelector('#mcp1');
    // answr1.innerText = array[index].answers[shuffled_questions[0]];
...
function getInput(){
    ...
    for(var x = 0; x < clicked.length; x++){
        ...
        if(clicked[x].checked === true){
            //something is wrong here below
            let userAnswer = clicked[x].value;
